...
class Vendas extends Controller
{
    ...
    public function imprimirCupomID($data){
        ...
        $produtos = $model->retornoProdutos($data["id"]);
    ...
    public function relacao()
    {
        ...
        foreach ($listaVendas as $venda) {
            ...
            $opcoes = "<a data-role='hint' data-hint-text='Imprimir Cupom' onclick='cupom($venda->orcamento);' href='#'><img class='imagem-acao' src='/assets/images/imprimir.png'></a>";
            $tabela["data"][] = [
                $venda->id,
                $dadosCliente->nome,
                $venda->orcamento,
